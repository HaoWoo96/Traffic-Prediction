...
python train.py --model_type Trans --task no_fact --use_dens --use_spd_all --use_spd_truck --use_spd_pv
python train.py --model_type Trans --task no_fact --use_spd_all --use_spd_truck --use_spd_pv
python train.py --model_type Trans --task no_fact --use_dens --use_spd_all 
...
python train.py --model_type Trans --task nonrec --use_dens --use_spd_all --use_spd_truck --use_spd_pv --use_expectation
...
python train.py --model_type Trans --task nonrec --use_spd_all --use_spd_truck --use_spd_pv --use_expectation
...
python train.py --model_type Trans --task nonrec --use_dens --use_spd_all --use_expectation
