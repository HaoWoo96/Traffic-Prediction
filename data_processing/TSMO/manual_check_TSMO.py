...
gdf_TSMO_tmc = gpd.read_file("./data/shape/tmc_shape_TSMO/tmc_shape_TSMO_for_sjoin.geojson")  # 1093 TMC segments in TSMO used for spatial join
...
gdf_TSMO_xd = gpd.read_file("./data/shape/xd_shape_TSMO/xd_shape_TSMO_for_sjoin.geojson")  # 1772 of 4723 XD segments in TSMO used for spatial join
...
'''
# df_raw_prev_tmc = pd.read_csv("./TSMO_raw_prev_tmc.csv")
