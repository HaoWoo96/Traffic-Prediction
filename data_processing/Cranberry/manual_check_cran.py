...
#             curr_tmc: {curr_tmc}    direction: {raw_xd_to_tmc_v2_difference_v1.iloc[i].direction_tmc.values[0]} \n \
#             curr_xd: {curr_xd}      direction: {raw_xd_to_tmc_v2_difference_v1.iloc[i].direction_xd.values[0]}", \
#                 fontsize=7)
